...
$lang['FormRules.pluginintegrations.events[][callback].format'] = 'Introduzca un método de callback para cada evento en el formato camelCaseName.';
$lang['FormRules.pluginintegrations.cards[][level].valid'] = 'Una o más tarjetas tienen un nivel no válido.';
$lang['FormRules.pluginintegrations.cards[][callback].format'] = 'Introduzca un método de callback para cada tarjeta en el formato camelCaseName.';
...
$lang['FormRules.merchantbasic.currencies.format'] = 'Introduzca las monedas en formato de tres caracteres separados por comas (por ejemplo, USD,EUR,JPY).';
...
$lang['FormRules.nonmerchantbasic.currencies.format'] = 'Introduzca las monedas en formato de tres caracteres separados por comas (por ejemplo, USD,EUR,JPY).';
