...
$lang['StripePayments.ach_form.mandate_future_usage'] = 'Si utiliza los servicios de %1$s o adquiere productos adicionales periódicamente de conformidad con las condiciones de %1$s, autoriza a %1$s a realizar cargos recurrentes en su cuenta bancaria. Los pagos que queden fuera de los débitos recurrentes autorizados anteriormente sólo se cargarán una vez obtenida su autorización.';
