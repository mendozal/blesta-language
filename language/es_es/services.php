...
$lang['Services.!error.pricing_id.overrides'] = 'El término del paquete no puede modificarse cuando se establecen precios fijos.';
...
$lang['Services.!error.override_price.format'] = 'El precio fijo debe ser un número.';
$lang['Services.!error.override_price.override'] = 'Tanto el precio como la divisa deben establecerse para fijar el precio actual.';
...
$lang['Services.!error.use_module.format'] = 'Formato de usar módulo no válido.';
...
$lang['Services.getActions.unsuspend'] = 'Desuspender';
$lang['Services.getActions.cancel'] = 'Cancelar';
$lang['Services.getActions.schedule_cancel'] = 'Agendar cancelación';
