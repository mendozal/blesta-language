...
$lang['AdminCompanyClientOptions.!tooltip.unique_contact_emails'] = 'Restringe las direcciones de email de los contactos. Contactos principales significa que no puede haber dos contactos principales (es decir, clientes) con la misma dirección de email. Todos los contactos significa que ningún contacto de ningún tipo puede tener la misma dirección de email que otro contacto.';
$lang['AdminCompanyClientOptions.!tooltip.force_email_usernames'] = 'Los clientes deben utilizar su dirección de email como nombre de usuario en lugar de definir uno propio. Los clientes existentes pueden seguir iniciando sesión con su nombre de usuario actual.';
$lang['AdminCompanyClientOptions.!tooltip.email_verification'] = 'Marque esta opción para enviar un email de verificación cuando se cree un nuevo inicio de sesión o un cliente cambie su dirección de email. Aparecerá un aviso en el perfil del cliente hasta que se verifique.';
...
$lang['AdminCompanyClientOptions.general.field_unique_contact_emails'] = 'Imponer direcciones de email de contacto únicas';
...
$lang['AdminCompanyClientOptions.general.field_force_email_usernames'] = 'Forzar nombres de usuario de email';
$lang['AdminCompanyClientOptions.general.field_email_verification'] = 'Activar la verificación del email';
