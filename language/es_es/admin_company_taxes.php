...
$lang['AdminCompanyTaxes.!success.taxrule_created'] = 'La regla impositiva se ha creado correctamente.';
$lang['AdminCompanyTaxes.!success.taxrule_updated'] = 'La norma fiscal se ha actualizado correctamente.';
$lang['AdminCompanyTaxes.!success.rule_deleted'] = 'La regla impositiva se ha eliminado correctamente.';
...
$lang['AdminCompanyTaxes.!tooltip.country'] = 'Seleccione el país al que se aplica esta regla impositiva.';
$lang['AdminCompanyTaxes.!tooltip.state'] = 'Seleccione el estado/provincia al que se aplica esta regla impositiva.';
$lang['AdminCompanyTaxes.basic.page_title'] = 'Configuración > Empresa > Impuestos > Configuración básica de impuestos';
$lang['AdminCompanyTaxes.basic.boxtitle_basic'] = 'Configuración impositiva básica';
$lang['AdminCompanyTaxes.basic.heading_general'] = 'Ajustes generales';
$lang['AdminCompanyTaxes.basic.field_enable_tax'] = 'Activar impuestos';
$lang['AdminCompanyTaxes.basic.note_enable_tax'] = 'Marque esta opción para activar los impuestos para esta empresa.';
$lang['AdminCompanyTaxes.basic.field_cascade_tax'] = 'Aplicar impuestos en cascada';
...
$lang['AdminCompanyTaxes.basic.field_setup_fee_tax'] = 'Impuestos a cargos de configuración';
$lang['AdminCompanyTaxes.basic.note_setup_fee_tax'] = 'Si está activada, se gravarán los cargos de configuración.';
$lang['AdminCompanyTaxes.basic.field_cancelation_fee_tax'] = 'Impuestos a cargos de anulación';
$lang['AdminCompanyTaxes.basic.note_cancelation_fee_tax'] = 'Si está activada, se gravarán los cargos de cancelación.';
$lang['AdminCompanyTaxes.basic.field_taxid'] = 'RUC/CI/Id Impositivo';
...
$lang['AdminCompanyTaxes.rules.page_title'] = 'Configuración > Empresa > Impuestos > Reglas impositivas';
$lang['AdminCompanyTaxes.rules.no_results'] = 'No existen reglas impositivas de nivel %1$s.';
$lang['AdminCompanyTaxes.rules.categorylink_addrule'] = 'Añadir regla impositiva';
$lang['AdminCompanyTaxes.rules.boxtitle_rules'] = 'Reglas impositivas';
$lang['AdminCompanyTaxes.rules.heading_level1'] = 'Reglas de nivel 1';
$lang['AdminCompanyTaxes.rules.heading_level2'] = 'Reglas de nivel 2';
...
$lang['AdminCompanyTaxes.rules.confirm_delete'] = '¿Está seguro de que desea eliminar esta regla impositiva?';
$lang['AdminCompanyTaxes.add.page_title'] = 'Configuración > Empresa > Impuestos > Añadir regla impositiva';
$lang['AdminCompanyTaxes.add.boxtitle_add'] = 'Añadir regla impositiva';
...
$lang['AdminCompanyTaxes.edit.page_title'] = 'Configuración > Empresa > Impuestos > Editar regla impositiva';
$lang['AdminCompanyTaxes.edit.boxtitle_edit'] = 'Editar regla impositiva';
