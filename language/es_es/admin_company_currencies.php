...
$lang['AdminCompanyCurrencies.!success.setup_updated'] = 'La configuración de monedas se ha actualizado correctamente.';
...
$lang['AdminCompanyCurrencies.!tooltip.multi_currency_pricing'] = 'Marque esta opción para permitir que los paquetes se pidan sólo utilizando los precios definidos para ese paquete. Marcar esta opción requiere que se defina el precio para cada divisa que desee aceptar para ese paquete. En otras palabras, esto evita que se realice la conversión de monedas.';
...
$lang['AdminCompanyCurrencies.!tooltip.exchange_rates_processor'] = 'Establece el procesador que se utilizará para actualizar los tipos de cambio. Las monedas disponibles varían según el procesador.';
...
$lang['AdminCompanyCurrencies.setup.page_title'] = 'Configuración > Empresa > Monedas > Configuración de monedas';
...
$lang['AdminCompanyCurrencies.setup.boxtitle_setup'] = 'Configuración de monedas';
...
$lang['AdminCompanyCurrencies.setup.field.exchange_rates_padding'] = 'Aumentar el tipo de cambio en';
...
$lang['AdminCompanyCurrencies.active.page_title'] = 'Configuración > Empresa > Monedas > Monedas activas';
$lang['AdminCompanyCurrencies.active.boxtitle_active'] = 'Monedas activas';
...
$lang['AdminCompanyCurrencies.add.page_title'] = 'Configuración > Empresa > Monedas > Añadir divisa';
...
$lang['AdminCompanyCurrencies.add.confirm_add'] = '¿Está seguro de que desea crear esta moneda? El tipo de cambio de esta moneda se sobrescribirá cuando los tipos de cambio se actualicen automáticamente en el sistema. Puede desactivar las actualizaciones automáticas en [Configuración] > [Empresa] > [Monedas] > [Configuración de monedas].';
$lang['AdminCompanyCurrencies.edit.page_title'] = 'Configuración > Empresa > Monedas > Editar divisa';
